 ...
 <table style="width:100%">
  ...
  <tr>
    <td class="index-auto-style1"> <!--New Arrival-->
		...
		<ul class="product_ul">
			<li class="product_name"><a href="">FateGrand Order - Saber  Altria Pendragon 1/7 Complete Figure</a></li>
  ...
  <tr>
    <td class="index-auto-style1"> <!--New Arrival-->
		...
		<ul class="product_ul">
		  <li class="product_name"><a href="">MARVEL BISHOUJO - MARVEL UNIVERSE Lady Deadpool 1/7 Complete Figure</a></li>
			<li class="in_stock">IN-STOCK</li>
