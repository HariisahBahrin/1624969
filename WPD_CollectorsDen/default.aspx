...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="indexpage">
    <div id="top_page">
        &nbsp;<img src="images/banner/new03.jpg" alt="FigFixRin_banner"/></div>
    ...
    <tr>
    <th class="index-auto-style1">New Arrivals</th>
    <th class="auto-style2">Female Figures</th> 
    <th class="auto-style3">Male Figures</th>
  </tr>
  <tr>
    <td class="index-auto-style1"> <!--New Arrival-->
		...
		<ul class="product_ul">
			 <li class="product_name"><a href="default.aspx">FateGrand Order - Saber  Altria Pendragon [Alter] Dress Ver. 17 Complete Figure</a></li>
    ...
    <td class="auto-style3"> <!--Male Figure-->
		...
		<ul class="product_ul">
		  <li class="product_name"><a href="default.aspx">ARTFX J - Code Geass Lelouch of the Rebellion R2 Lelouch CODE BLACK 1st Live Encore! ver. 18 Complete Figure</a></li>
			<li class="in_stock">IN-STOCK</li>
  ...
  <tr>
    <td class="index-auto-style1"> <!--New Arrival-->
		...
		<ul class="product_ul">
		  <li class="product_name"><a href="default.aspx">MARVEL BISHOUJO - MARVEL UNIVERSE Lady Deadpool 17 Complete Figure</a></li>
			<li class="in_stock">IN-STOCK</li>
    ...
    <td class="auto-style2"><!--Female Figure-->
		<a href="female_figures.aspx">>> See More "Female Figure"</a>
	    </td> 
    <td class="auto-style3"><!--Male Figure-->
		<a href="male_figures.aspx">>> See More "Male Figure"</a>
	    </td>
  </tr>
</table>
</div>
