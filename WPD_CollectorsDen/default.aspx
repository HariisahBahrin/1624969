...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <tr>
    ...
    <td class="index-auto-style1"> <!--New Arrival-->
		<a href="content_products/products.aspx">>> See More "Products"</a>
	    </td>
    <td class="auto-style2"><!--Female Figure-->
		<a href="content_products/gundam.aspx">>> See More "Gundam"</a>
	    </td> 
    <td class="auto-style3"><!--Male Figure-->
		<a href="content_products/scifi.aspx">>> See More "SciFi Merchandise"</a>
	    </td>
  </tr>
</table>
</div>
